// In this example we also have two components - a picture and a picture list.
// The pictures are fetched from Instagram via AJAX.


// This component doesn't hold any state -  it simply transforms whatever was passed as
//    as attributes into HTML that represents a picture.
var Picture = React.createClass({

    //When the component is clicked, trigger the onClick handler that was passed as
    //  as an attribute when it was constructed:
...
var PictureList = React.createClass({
    ...
    // The pictures array will be populated via AJAX, and the favorites one when the user clicks on an image:
    ...
    componentDidMount: function(){
        ...
        $.getJSON(url, function(result){
            ...
            // Note that this only updates the pictures property, and doesn't remove the favorites array.
...
// I am using an API key for a Instagram test ap. Please generate and use your own from here:
// http://instagram.com/developer/

ReactDOM.render(
    <PictureList apiKey="642176ece1e7445e99244cec26f4de1f" />, document.getElementById('container')
);
